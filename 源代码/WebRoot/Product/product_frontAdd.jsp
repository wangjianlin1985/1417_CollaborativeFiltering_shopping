	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="product_recipeFlag" class="col-md-2 text-right">是否特价:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_recipeFlag" name="product.recipeFlag" class="form-control" placeholder="请输入是否特价">
					 </div>
				  </div>
				  <div class="form-group">

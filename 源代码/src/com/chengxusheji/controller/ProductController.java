...
public class ProductController extends BaseController {
	...
	public String reCommendList(HttpServletRequest request,HttpServletResponse response,HttpSession session) throws Exception {
		String user_name = (String) session.getAttribute("user_name"); 
		if(user_name != null) {
			List<Product> productList = productService.queryRecommendProductList(user_name);
			request.setAttribute("productList",  productList);
		} 
		
		return "Product/product_recommend"; 
	}
	...
	public String frontshow(@PathVariable Integer productId,Model model,HttpServletRequest request) throws Exception {
        ...
        List<Product> similarProductList = productService.querySimilarProductList(productId); 
	...
	public void OutToExcel(String addTime,@ModelAttribute("productClassObj") ProductClass productClassObj,String productName,String recommandFlag,String recipeFlag, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String[] headers = { "商品id","商品类别","商品名称","商品图片","商品库存","商品价格","是否推荐","是否特价","发布时间"};
